...
(function (jQuery) {
    ...
    Collapser = (function () {
        ...
        Collapser.bindEvent = function (item, options) {
            ...
            collapser.innerHTML = options.collapsed ? 'expand_more' : 'expand_less';
        ...
        Collapser.expand = function (collapser) {
            ...
            return collapser.innerHTML = 'expand_less';
        };
        ...
        Collapser.collapse = function (collapser) {
            ...
            return collapser.innerHTML = 'expand_more';
        };
    ...
    return $.fn.JSONView = function () {
        ...
        if (JSONView[args[0]] != null) {
            ...
            return this.each(function () {
                ...
                if (args[1] != null) {
                    level = args[1];
                    return $this.find(".jsonview .can-collapse.level" + level).siblings('.collapser').each(function () {
                        return JSONView[method](this);
                    });
                }
                else {
                    return $this.find('.jsonview > ul > li .can-collapse').siblings('.collapser').each(function () {
                        return JSONView[method](this);
                    });
                }
            });
